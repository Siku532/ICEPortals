...
@NgModule({
  declarations: [HomeComponent, DetailsPageComponent, MainPageComponent,
    SectionOneViewComponent, SectionTwoViewComponent,
     ...
     SectionFiveComponent, SectionSixComponent, SectionSevenViewComponent, SectionNineViewComponent, SectionEightViewComponent, SectionTenViewComponent, SectionElevenViewComponent],
  imports: [
    CommonModule,
